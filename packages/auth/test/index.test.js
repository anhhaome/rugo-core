...
describe('Auth test', () => {
  ...
  it('should forbidden and bad request', async () => {
    ...
    expect(context).to.not.has.property('user');
    ...
    expect(context2).to.not.has.property('user');
